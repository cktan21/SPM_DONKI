...
const statuses = [
    ...
    },
    {
        ...
        label: "Blocked",
        icon: Ban,
        class: "bg-purple-50 text-purple-700 border-purple-200 hover:bg-purple-100 dark:bg-purple-500/10 dark:text-purple-400 dark:border-purple-500/20 dark:hover:bg-purple-500/20"
    },
    {
        value: "overdue",
        label: "Overdue",
    ...
    <Popover v-model:open="isOpen">
        <PopoverTrigger as-child>
            <Button
                ...
                @click.stop
                :disabled="isUpdating">
                <component :is="currentStyle.icon" class="h-3 w-3 mr-1.5" />
                {{ currentStyle.label }}
            </Button>
        </PopoverTrigger>
        <PopoverContent
            class="w-40 p-1.5 shadow-lg border-slate-200 dark:border-slate-800"
            align="start"
            @click.stop>

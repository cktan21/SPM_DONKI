        ...
        <CardContent class="pt-6">
          ...
          <form @submit.prevent="createTask" class="space-y-6">
            ...
            <div class="space-y-4">
              ...
              <div class="grid gap-4 sm:gap-6">
                ...
                <div class="space-y-2">
                  ...
                  <Input id="task-name" v-model="formCreate.name" placeholder="Enter a descriptive task name" required
                    class="w-full" />
                ...
                <div class="grid gap-4 sm:grid-cols-2">
                  ...
                  <div class="space-y-2">
                    ...
                    <Input id="task-pid" v-model="formCreate.pid" placeholder="Optional project identifier"
                  ...
                  <div class="space-y-2">
                    ...
                    <Input id="task-parent" v-model="formCreate.parentTaskId" placeholder="Optional parent task"
                      class="w-full" />
                ...
                <div class="space-y-2">
                  ...
                  <Textarea id="task-description" v-model="formCreate.desc"
                    placeholder="Describe the task purpose, requirements, and any important details..."
                    class="resize-none min-h-[100px] w-full" rows="4" />
                ...
                <div class="space-y-2">
                  ...
                  <Input id="task-notes" v-model="formCreate.notes" placeholder="Any extra information or reminders"
                    class="w-full" />
                ...
                <div class="grid gap-4 sm:grid-cols-2">
                  ...
                  <div class="space-y-2">
                    ...
                    <Input id="task-priority" v-model="formCreate.priorityLevel" type="number" min="1" max="10"
                      placeholder="1-10" class="w-full" />
                ...
                <div class="space-y-2">
                  ...
                  <Popover v-model:open="isCollaboratorPopoverOpen">
                    <PopoverTrigger as-child>
                      <Button variant="outline" role="combobox" class="w-full justify-between">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="ml-2 h-4 w-4 shrink-0 opacity-50"
                      ...
                      <div class="p-2">
                        ...
                        <div class="max-h-48 overflow-auto">
                          <button v-for="user in filteredUsers" :key="user.id" type="button"
                            ...
                            {{ user.name }}
                            <span v-if="selectedCollaborators.includes(user.id)"
                  ...
                  <div class="flex flex-wrap gap-2 mt-2" v-if="selectedCollaborators.length > 0">
                    <span v-for="id in selectedCollaborators" :key="id"
                      class="px-2 py-1 bg-secondary text-sm rounded-full flex items-center gap-1">
                      {{ getUserName(id) }}
                      <button type="button" @click="removeCollaborator(id)"
                  ...
                  <Input v-model="formCreate.collaboratorsCsv" type="hidden" />
                </div>
                  ...
                  <div class="space-y-2">
                    ...
                    <Popover>
                      ...
                      <PopoverTrigger as-child>
                        ...
                        <Button variant="outline" class="w-full justify-start text-left font-normal" id="task-start">
                      ...
                      <PopoverContent class="w-auto p-0" :align="'start'">
                        ...
                        <Calendar :model-value="formCreate.schedule.start as DateValue | undefined"
                  ...
                  <div class="space-y-2">
                    ...
                    <Popover>
                      ...
                      <PopoverTrigger as-child>
                        ...
                        <Button variant="outline" class="w-full justify-start text-left font-normal" id="task-deadline">
                      ...
                      <PopoverContent class="w-auto p-0" :align="'start'">
                        ...
                        <Calendar :model-value="formCreate.schedule.deadline as DateValue | undefined"
            ...
            <div class="flex flex-col-reverse sm:flex-row sm:justify-end gap-3 pt-2">
              ...
              <Button variant="outline" type="button" @click="handleBack" class="w-full sm:w-auto">

                Cancel

              </Button>

              <Button type="submit" :disabled="state.creating" class="w-full sm:w-auto">

                <svg v-if="state.creating" xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2 animate-spin"

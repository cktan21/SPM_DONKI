...
const isDateRangeValid = computed(() => {
  if (!formCreate.value.schedule.start || !formCreate.value.schedule.deadline) {
  ...
  const deadlineDate = formCreate.value.schedule.deadline.toDate(getLocalTimeZone())
...
const createTask = async () => {
  ...
  try {
    ...
    schedule.is_recurring = formCreate.value.isRecurring
          ...
          <form @submit.prevent="createTask" class="space-y-6">
            ...
            <div class="space-y-4">
              ...
              <div class="grid gap-4 sm:gap-6">
                ...
                <div class="grid gap-4 sm:grid-cols-2">
                  <div class="space-y-2">
                    <Label for="task-pid" class="text-sm font-medium">
                      Project ID
                    </Label>
                    <Input
                      id="task-pid"
                  ...
                  <div class="space-y-2">
                    <Label for="task-parent" class="text-sm font-medium">
                      Parent Task ID
                    </Label>
                    <Input
                      id="task-parent"
                ...
                <div class="space-y-2">
                  <Label for="task-notes" class="text-sm font-medium">
                    Additional Notes
                  </Label>
                  <Input
                    id="task-notes"
                ...
                <div class="grid gap-4 sm:grid-cols-2">
                  <div class="space-y-2">
                    <div class="flex items-center gap-2">
                      <Label for="task-priority" class="text-sm font-medium">
                        Priority Level (1-10)
                      </Label>
                      <Popover>
                ...
                <div class="space-y-2">
                  <Label for="task-collaborators" class="text-sm font-medium">
                    Collaborators
                  </Label>
                      ...
                      <div class="p-2">
                        ...
                        <div class="max-h-48 overflow-auto">
                          ...
                          >
                            {{ user.name }}
                            <span
                              v-if="selectedCollaborators.includes(user.id)"
            ...
            <div class="space-y-4">
              ...
              <div class="grid gap-4">
                <div class="space-y-2">
                  <Label for="task-status" class="text-sm font-medium">
                    Status
                  </Label>
                ...
                <div class="grid gap-4 sm:grid-cols-2">
                  <div class="space-y-2">
                    <Label for="task-start" class="text-sm font-medium">
                      Start Date
                    </Label>
                    <Popover>
                      <PopoverTrigger as-child>
                        ...
                        >
                          ...
                          <span class="flex-1 truncate">
                            {{ formatDate(formCreate.schedule.start) }}
                          </span>
                        </Button>
                      </PopoverTrigger>
                  ...
                  <div class="space-y-2">
                    <Label for="task-deadline" class="text-sm font-medium">
                      Deadline
                    </Label>
                    <Popover>
                      <PopoverTrigger as-child>
                        ...
                        >
                          ...
                          <span class="flex-1 truncate">
                            {{ formatDate(formCreate.schedule.deadline) }}
                          </span>
                        </Button>
                      </PopoverTrigger>
                      <PopoverContent class="w-auto p-0" :align="'start'">
                ...
                <div class="space-y-4 p-4 border rounded-lg">
                  <div class="space-y-2">
                    <Label for="task-recurring" class="text-sm font-medium">
                      Is Recurring Task?
                    </Label>
                  ...
                  >
                    <div class="space-y-2">
                      <Label for="task-frequency" class="text-sm font-medium">
                        Frequency
                      </Label>
                    ...
                    <div v-if="nextOccurrence" class="p-3 bg-muted rounded-md">
                      <p class="text-sm font-medium mb-1">
                        Next Occurrence (Auto-calculated)
                      </p>
                      ...
                      <p class="text-xs text-muted-foreground mt-1">
                        ...
                        {{ formCreate.schedule.frequency }} frequency
                      </p>
                    </div>
                  </div>
                </div>
